...
for scenario_id, data in scenario_data.items():
    ...
    for entry in data:
        if entry[1] == "":
            break
        cpp_code += (
            f"    {{{entry[0]}, {entry[1]}, {entry[2]}, {entry[3]}, {61 - i}}},\n"
        )
        i += 1
    cpp_code += "};\n"
    ...
    for entry in data:
        ...
        cpp_code += (
            f"    {{{entry[4]}, {entry[5]}, {entry[6]}, {entry[7]}, {70 - i}}},\n"
        )
    ...
    for entry in data:
        ...
        cpp_code += (
            f"    {{{entry[8]}, {entry[9]}, {entry[10]}, {entry[11]}, {79 - i}}},\n"
        )
        i += 1
    cpp_code += "};\n"
    ...
    for entry in data:
        ...
        cpp_code += (
            f"    {{{entry[12]}, {entry[13]}, {entry[14]}, {entry[15]}, {94 - i}}},\n"
        )
        i += 1
    cpp_code += "};\n"
    ...
    for entry in data:
        if entry[16] == "":
            break
        cpp_code += (
            f"    {{{entry[16]}, {entry[17]}, {entry[18]}, {entry[19]}, {77 - i}}},\n"
        )
        i += 1
    cpp_code += "};\n"
    ...
    for entry in data:
        if entry[20] == "":
            break
        cpp_code += (
            f"    {{{entry[20]}, {entry[21]}, {entry[22]}, {entry[23]}, {59 - i}}},\n"
        )
        i += 1
    cpp_code += "};\n"
